...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.address'
        db.add_column(u'retails_shop', 'address',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Sale.closed_by'
        db.alter_column(u'retails_sale', 'closed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'Shop.address'
        db.delete_column(u'retails_shop', 'address')


        # User chose to not deal with backwards NULL issues for 'Sale.closed_by'
        raise RuntimeError("Cannot reverse this migration. 'Sale.closed_by' and its values cannot be restored.")
