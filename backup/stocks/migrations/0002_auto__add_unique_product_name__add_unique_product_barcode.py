...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Product', fields ['barcode']
        db.create_unique(u'stocks_product', ['barcode'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['barcode']
        db.delete_unique(u'stocks_product', ['barcode'])
