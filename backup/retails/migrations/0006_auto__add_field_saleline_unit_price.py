...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SaleLine.unit_price'
        db.add_column(u'retails_saleline', 'unit_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=12, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SaleLine.unit_price'
        db.delete_column(u'retails_saleline', 'unit_price')
