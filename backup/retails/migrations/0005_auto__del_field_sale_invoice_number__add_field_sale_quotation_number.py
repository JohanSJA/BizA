...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sale.quotation_number'
        db.add_column(u'retails_sale', 'quotation_number',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sale.quotation_number'
        db.delete_column(u'retails_sale', 'quotation_number')
