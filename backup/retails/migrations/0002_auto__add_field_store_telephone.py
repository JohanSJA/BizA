...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.telephone'
        db.add_column(u'retails_store', 'telephone',
                      self.gf('django.db.models.fields.CharField')(default='(+60)4-3318388', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.telephone'
        db.delete_column(u'retails_store', 'telephone')
