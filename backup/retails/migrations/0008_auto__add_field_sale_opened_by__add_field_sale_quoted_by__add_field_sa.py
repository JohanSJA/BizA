...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.opened_by'
        db.add_column(u'retails_sale', 'opened_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='opened_sale_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Sale.quoted_by'
        db.add_column(u'retails_sale', 'quoted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quoted_sale_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Sale.closed_by'
        db.add_column(u'retails_sale', 'closed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='closed_sale_set', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.opened_by'
        db.delete_column(u'retails_sale', 'opened_by_id')

        # Deleting field 'Sale.quoted_by'
        db.delete_column(u'retails_sale', 'quoted_by_id')

        # Deleting field 'Sale.closed_by'
        db.delete_column(u'retails_sale', 'closed_by_id')
    ...
    models = {
        ...
        u'retails.sale': {
            ...
            'closed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'closed_sale_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'closing_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opened_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'opened_sale_set'", 'to': u"orm['auth.User']"}),
            ...
            'quoted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'quoted_sale_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
