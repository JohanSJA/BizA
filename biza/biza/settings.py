...
PROJECT_DIR = os.path.abspath(os.path.dirname(SETTING_DIR))
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'biza_dev.db'),
...
SECRET_KEY = '9d*vu*nubzux449sdw2o2vbl)7)n3^a!$$e1v@#tr02$6_@x=v'
