...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'retails_store', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


        # Changing field 'Store.telephone'
        db.alter_column(u'retails_store', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):
        # Deleting field 'Store.email'
        db.delete_column(u'retails_store', 'email')


        # Changing field 'Store.telephone'
        db.alter_column(u'retails_store', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=12))
